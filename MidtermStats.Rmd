...
vioplot(surveydata$Hours, col = "darkgoldenrod1", xlab = "Hours", horizontal = TRUE, main = "Time to Finish Midterm")
...
boxplot(gradedata[, c("TRS", "TAS", "FTS")], col = c("skyblue3", "coral1", "darkgoldenrod1"), xlab = "Percent", horizontal = TRUE)

boxplot(gradedata[, c("TRP", "TAP", "TFP")], col = c("skyblue3", "coral1", "darkgoldenrod1"), xlab = "Percent", horizontal = TRUE)
